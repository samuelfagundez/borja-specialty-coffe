      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a
            ...
            className="rounded-full border border-blush-dark px-4 py-2 text-sm font-semibold text-blush-dark transition hover:bg-blush-dark hover:text-cream"
          >
            Contáctanos
          </a>
          <a
        ...
        <div className="border-t border-black/5 bg-cream px-4 pb-5 md:hidden">
          ...
          <div className="mt-3 flex flex-col gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border border-blush-dark px-4 py-2.5 text-center text-sm font-semibold text-blush-dark"
            >
              Contáctanos
            </a>
            <a
