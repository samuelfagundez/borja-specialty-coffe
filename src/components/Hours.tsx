  ...
  return (
    <section id="horario" className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      <div className="grid gap-12 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center gap-6 rounded-3xl bg-blush/15 p-8">
          <div>
          ...
          <p className="text-sm leading-relaxed text-ink/75">
            Terraza, aseos y entrada accesibles, menú infantil y se admiten perros. Se acepta
            tarjeta de débito y pago sin contacto.
          </p>
        </div>
      </div>
    </section>
